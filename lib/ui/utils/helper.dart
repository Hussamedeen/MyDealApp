...
String validateName(String value) {
  ...
  if (value.length == 0) {
    ...
    return "يجب أن يكون الاسم من a-z و A-Z";
  }
  return null;
}
...
String validateMobile(String value) {
  ...
  RegExp regExp = new RegExp(patttern);
  if (value.length == 0) {
    return "رقم الهاتف المحمول مطلوب";
  } else if (!regExp.hasMatch(value)) {
    return "يجب أن يحتوي رقم الهاتف المحمول على أرقام فقط";
  }
  return null;
}
...
String validatePassword(String value) {
  if (value.length < 6)
    return 'يجب أن تكون كلمة المرور أكثر من 5 أحرف';
  else
    return null;
}
